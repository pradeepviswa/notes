...
## pre-requiestes
Install Jenkins: https://github.com/pradeepviswa/deployment-scripts/blob/main/install_jenkins_ubuntu.sh
...
- On Jenkisn machine once below steps are done try to acess tompact at port 9090. Example http://54.82.98.100:9090
```
sudo su
...
pipeline{
    ...
    stages{
        ...
        stage("7: Deploy the project"){
            steps{
                sh 'sudo cp  /var/lib/jenkins/workspace/test1/target/addressbook.war /home/ubuntu/apache-tomcat-9.0.113/webapps'
            }
        }//state 7
    }//stages
