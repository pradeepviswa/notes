...
(a) Install commands for master and node to configure k8s cluster: https://github.com/pradeepviswa/deployment-scripts/blob/main/k8s.sh
(b) **run below cluster join command on node1 and node2.**
...
(c) **run below command on master node to check cluster status**
